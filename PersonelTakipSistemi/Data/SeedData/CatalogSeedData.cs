...
namespace PersonelTakipSistemi.Data.SeedData
{
    internal static class CatalogSeedData
    {
        public static IEnumerable<Brans> GetBransSeed()
        {
        ...
        public static IEnumerable<Yazilim> GetYazilimSeed()
        {
        ...
        public static IEnumerable<Uzmanlik> GetUzmanlikSeed()
        {
        ...
        public static IEnumerable<GorevTuru> GetGorevTuruSeed()
        {
        ...
        public static IEnumerable<IsNiteligi> GetIsNiteligiSeed()
        {
